  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <TabsContent value="framework" className={activeTab === 'framework' ? 'block' : 'hidden'}>
        ...
        <TabsContent value="certification" className={activeTab === 'certification' ? 'block' : 'hidden'}>
        ...
        {/* 4. How Our AI Works */}
        <TabsContent value="ai" className={activeTab === 'ai' ? 'block' : 'hidden'}>
          <section className="w-full py-16 bg-white">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
        ...
        <TabsContent value="privacy" className={activeTab === 'privacy' ? 'block' : 'hidden'}>
          <section className="w-full py-16 bg-gray-50">
            <div className="container mx-auto px-4">
